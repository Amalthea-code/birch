  ...
  <div class="docs">
    ...
    >
      ...
      <span class="docs__sub-info"
        >Без указанных документов ребенок в СОЦ не допускается.</span
      >
      <br/><br/>По возникшим медицинским вопросам и справкам вы можете получить информацию у нашего медицинского сотрудника Врача педиатра <a href="tel:+79271592895">+7 (927) 159-28-95</a>
