<template>
  <div class="docs">
    ...
    <div class="docs__info">
      ...
      <p class="docs__text">График работы Отдела продаж: Вт-Сб с 11:00 до 16:00, обед с 13:00 до 14:00. Также Вы можете получить путевку в день заезда при регистрации.</p>
      <br />
