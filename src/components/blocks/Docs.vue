<template>
  <div class="docs">
    ...
    <div class="docs__info">
      <p class="docs__text">* После полной оплаты Путевки Вы можете забрать ее на бумажном носителе в лагере по адресу: 410056, г. Саратов, Большая Кумысная поляна, АНО СОЦ «Берёзка», т.: +7 937 225-62-44 (Отдел продаж). </p>
      <p class="docs__text">График работы Отдела продаж: Вт-Сб с 11:00 до 17:00, обед с 13:00 до 14:00. Также Вы можете получить путевку в день заезда при регистрации.</p>
      <br />
