      ...
      return {
        relaxation: [
          ...
          },
          {
            title: 'ПРОКАТ ЛЫЖ',
            color: '#60ABF0',
            text: 'Прокат лыж начинает работать с устойчивым покровом снега и располагается в Зимнем корпусе.<br /><br />В прокате представлены лыжи различных марок. В помещении работают раздевалка и туалеты.<br /><br /><strong>Стоимость проката:</strong> 250 руб./первый час, последующие 30 мин./50 руб. Дети до 10 лет: 150 руб./час, последующие 30 мин./50 руб.<br /><br /><strong>График работы:</strong> ср. - вск. с 9:00 до 16:00<br /><br /><strong>Телефон:</strong><a href="tel:+78452563107" style="color: black">+7(8452) 56-31-07</a>',
            aligin: 'left',
            slider: true,
            infoBox: true,
