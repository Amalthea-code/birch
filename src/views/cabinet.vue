  ...
  <div class="cabinet">
    <div class="cabinet__box">
      ...
      <div class="cabinet__info">
        ...
        Информацию о Вашей покупке с указанием смены и сроков поездки вы можете увидеть в чеке, который придёт Вам на электронную почту. Забрать путёвку Вы сможете в лагере в часы работы отдела продаж 11.00 - 16.00 вт-сб. Или в день заезда в смену. ВСЯ ИНФОРМАЦИЯ ПО ДОКУМЕНТАМ, СПРАВКАМ, СМЕНАМ ЕСТЬ НА САЙТЕ В РАЗДЕЛЕ <router-link to="/parents">"РОДИТЕЛЯМ"</router-link>
      </div>
