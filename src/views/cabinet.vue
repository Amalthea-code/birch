  ...
  <div class="cabinet">
    <div class="cabinet__box">
      ...
      <div class="cabinet__info">
        ...
        Информацию о Вашей покупке с указанием смены и сроков поездки вы можете увидеть в путевке, которая придёт Вам на электронную почту вместе с чеком. Распечатайте путевку и предъявите ее вместе с остальными документами в день заезда. ВСЯ ИНФОРМАЦИЯ ПО ДОКУМЕНТАМ, СПРАВКАМ, СМЕНАМ ЕСТЬ НА САЙТЕ В РАЗДЕЛЕ <router-link to="/parents">"РОДИТЕЛЯМ"</router-link>
      </div>
