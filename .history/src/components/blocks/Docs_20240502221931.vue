  ...
  <div class="docs">
    ...
    >
      ...
      <span class="docs__sub-info"
        >Без указанных документов ребенок в СОЦ не допускается.<br/><br/>По возникшим медицинским вопросам и справкам вы можете получить информацию у нашего медицинского сотрудника Врача педиатра <a href="tel:+79271592895">+7 (927) 159-28-95</a></span
      >
    ...
    >
      ...
      <ul>
        ...
        <li class="docs__info-text">
          Санитарно-эпидемиологическое заключение вы можете получить в рабочее
          время отдела продаж, не ранее 2-х дней до окончания смены;
        </li>
      </ul>
      <span class="docs__sub-info"
        >Получить все необходимые документы Вы сможете по окончании смены,
        предварительно позвонив по номеру телефона отдела продаж
        <a href="tel:+78452256244">+7(8452) 25-62-44</a>.</span
      >
    </info>
    <info
      class="docs__card"
